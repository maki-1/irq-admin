...
import {
  FiGrid, FiFileText, FiMenu, FiX,
  FiSearch, FiMessageCircle, FiBell,
  FiUser, FiLogOut, FiChevronDown, FiActivity, FiHome, FiCreditCard,
} from 'react-icons/fi';
...
const NAV = [
  ...
  { to: '/purok-leader/residents',      label: 'RESIDENTS',      Icon: FiHome       },
  { to: '/purok-leader/collection',     label: 'COLLECTION',     Icon: FiCreditCard },
  { to: '/purok-leader/clearance-fees', label: 'CLEARANCE FEES', Icon: FiFileText   },
  { to: '/purok-leader/logs',           label: 'LOGS',           Icon: FiActivity   },
];
    ...
    <>
      <div className="flex flex-col items-center mb-6 pt-6 px-4">
        ...
        <span style={{
          ...
          color: '#7C3AED', fontSize: 18, fontWeight: 700, letterSpacing: 2,
        }}>
          DOLOGON
        </span>
      </div>
          ...
          >
            {({ isActive }) => (
              <>
                ...
                <Icon size={20} style={{ color: isActive ? '#7C3AED' : '#827575', flexShrink: 0 }} />
                <span style={{
                  fontFamily: "'Kaisei Decol', serif",
                  fontSize: 15, fontWeight: 400,
                  color: isActive ? '#7C3AED' : '#827575',
                }}>
                  {label}
                </span>
              </>
            ...
            <>
              ...
              >
                <div className="flex items-center gap-3 px-4 py-3" style={{ borderBottom: '1px solid #F0EAEA' }}>
                  <div className="w-10 h-10 rounded-full overflow-hidden border-2 shrink-0" style={{ borderColor: '#7C3AED' }}>
                    <img src={assets.DOLOGONLOGO} alt="avatar" className="w-full h-full object-cover" />
                  </div>
                ...
                <ul className="py-1">
                  <li>
                    <button
                      ...
                      onClick={() => { setAvatarOpen(false); navigate('/purok-leader/profile'); }}
                    >
