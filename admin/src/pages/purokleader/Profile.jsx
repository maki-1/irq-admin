...
export default function PurokLeaderProfile() {
  ...
  return (
    <PurokLeaderLayout title="MY PROFILE">
      <div className="flex flex-col lg:flex-row gap-5 max-w-4xl">
        ...
        >
          <div className="rounded-full overflow-hidden border-4"
            style={{ width: 110, height: 110, borderColor: '#7C3AED' }}>
            <img src={assets.DOLOGONLOGO} alt="avatar" className="w-full h-full object-cover" />
          </div>

          <div className="text-center">
            <p style={{ fontFamily: "'Kaisei Decol', serif", color: '#7C3AED', fontSize: 18, fontWeight: 700 }}>
              {user?.fullName}
            </p>
            <span className="inline-block mt-1 px-3 py-0.5 rounded-full text-white text-xs"
              style={{ background: '#7C3AED', fontFamily: "'Hahmlet', sans-serif" }}>
              {user?.role}
            </span>
          </div>
        ...
        <div className="flex flex-col gap-4 flex-1 min-w-0">
          ...
          <form onSubmit={saveProfile} className="bg-white rounded-3xl p-6"
            ...
            <p className="mb-5"
              style={{ fontFamily: "'Kaisei Decol', serif", color: '#7C3AED', fontSize: 17 }}>
              Edit Profile
            </p>
