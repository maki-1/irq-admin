...
export default function Otp() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right — form */}
      <div className="flex-1 lg:w-1/2 flex flex-col items-center justify-center bg-white px-4 sm:px-8 py-12 lg:px-16">
            ...
            <div className="flex gap-2 sm:gap-3 justify-center" onPaste={handlePaste}>
              {digits.map((d, i) => (
                <input
                  ...
                  maxLength={1}
                  inputMode="numeric"
                  className={`w-9 h-12 sm:w-11 sm:h-14 rounded-xl text-center text-xl font-bold transition-all outline-none
                    ${d
