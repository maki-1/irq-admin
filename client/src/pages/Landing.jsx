    ...
    <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'bg-[#0d1f0d]/90 backdrop-blur-xl border-b border-white/10 shadow-lg' : 'bg-transparent'}`}>
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <Link to="/login"
            className="ml-3 px-5 py-2 text-sm font-medium text-green-rich bg-gold hover:bg-gold-light rounded-full transition-colors">
            Staff Login
          </Link>
        </div>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-[#0d1f0d]/95 backdrop-blur-xl border-t border-white/10 px-6 py-4 flex flex-col gap-2">
          ...
          <Link to="/login" className="btn-primary text-center mt-2 py-2.5 rounded-full text-sm">
            Staff Login
          </Link>
        </div>
      )}
      ...
      <footer className="bg-[#080f08] border-t border-white/10 py-10 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
            ...
            <Link to="/login"
              className="px-7 py-2.5 rounded-full bg-gold text-green-rich text-sm font-semibold hover:bg-gold-light transition-colors">
              Staff Portal Login
            </Link>
          </div>
